...
/**
 *  Representa un jugador de Reversi. Al ser una clase abstracta, en la práctica los jugadores
 *  deben ser descendientes de esta clase. Cada jugador de Reversi se ejecuta
...
abstract public class Jugador implements Runnable, Serializable {
   ...
   private int tipo;
   /**
    * Referencia al {@link clasesBasicas.Juego juego} en el que participa el jugador.
    */
   private Juego j;
   /**
