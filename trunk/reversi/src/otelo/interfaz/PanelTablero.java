...
/**
* Representa en pantalla el tablero donde se juega la partida. Es la clase encargada
* de dibujarlo en pantalla y de recoger los eventos del ratón
* que representan las jugadas del usuario.
*/
...
g.fillRect(col*TAM_CASILLA+MARGEN_CASILLA, fila*TAM_CASILLA+MARGEN_CASILLA, TAM_FICHA_POS, TAM_FICHA);
g.setColor(colorAct);
}
...
cas = obtCasillaXY((int)e.getPoint().getX(), (int)e.getPoint().getY());
...
return new Casilla((int)(y/PanelTablero.TAM_CASILLA), (int)(x/PanelTablero.TAM_CASILLA));
}
